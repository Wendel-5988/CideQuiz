...
const $gordinhoGif = document.querySelector("#gordinho-dancando")
...
function finishGame() {
    ...
    switch (true) {
        case (performance >= 90):
            message = "Parabéns! Você gabaritou! Nosso mini divo Matheus ta até dançando de felicidades..."
            $gordinhoGif.classList.remove("hide")
            break
        case (performance >= 70):
